---
layout: single
title: "[Project][KEDUIT] 클라우드 컴퓨팅과 보안솔루션을 활용한 DC 엔지니어 양성교육 - Day55 ~ 64"
categories: keduit
tags:
  [2023/05/08, Day64, 한국정보교육원, 국비교육, Network, Linux, Server, Project]
toc: true
toc_sticky: true
author_profile: true
comments: true
...
&nbsp;&nbsp;&nbsp;&nbsp;2주간의 짧다면 짧고 길다면 긴 프로젝트 기간이 끝났다.

## 2. 본론

### 1. 보고서

[첫번째 프로젝트](https://www.canva.com/design/DAFhK3moOJc/2IkzqzWI2rhrSzD3NvT9dA/edit?utm_content=DAFhK3moOJc&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton)

### 2. Project 후기

&nbsp;&nbsp;&nbsp;&nbsp;약 2달간 배운 내용을 바탕으로 이번 프로젝트를 진행하면서 새롭게 알아가는 부분들도 많았고, 반대로 어떤 부분에 대한 지식이 부족한지도 알 수 있었다.

## 3. 결론

&nbsp;&nbsp;&nbsp;&nbsp;완벽하진 않지만 처음으로 진행해본 프로젝트 결과물이 뿌듯하다.
