...
```
Change the logical volume capacity 'lvol0' from 190M to 300M. And the size of the floating range should set between 280 and 320. (This logical volume has been mounted in advance.)
```
...
# pvcreate /dev/sdd
# vgcreate vo /dev/sdd
# lvcreate -n lvo1 -L +190M
 
```

```
# vgdisplay
# lvextend -L +110M lvol0
# vgdisplay
# 
```
