...
```
Create a volume group(lv), and set 8M as a extends. Divided a volume group containing 50 extends on volume group lv (lvshare), and mounted automatically under /dev/sde. And the size of the floating range should set between 380M and 400M.
```
