...
//R2
# conf t
# ntp server 15.15.2.2 //Serial Interface를 지정하면 해당 Interface가 shut down됐을 때 문제가 생긴다. 하지만 Loolback으로 지정해주면 접근할 수 있는 다른 Interface가 있으면 해당 Interface로 접근하여 NTP를 Sync한다.
# do show clock //verify

//hop 임의조정
//R1
# conf t
# ip access-list 1 permit 15.15.1.0 0.0.0.255
# router rip
