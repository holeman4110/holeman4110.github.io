...
title: "[K8S] 따배쿠 후기"
categories: cloud
tags: [2023/05/26, kubernetes, k8s]
toc: true
toc_sticky: true
author_profile: true
comments: true
...
&nbsp;&nbsp;&nbsp;&nbsp;[CKA](https://training.linuxfoundation.org/certification/certified-kubernetes-administrator-cka/) 준비를 위해 [따배쿠 by TTABAE-LEARN](https://www.youtube.com/@ttabae-learn4274) 강의를 일주일간 수강했다. 이 강의에 대한 간단한 후기를 남겨보려고 한다.
...
1. 좋은 점
- Youtube 강의라 무료다.
- Udemy 강의를 듣기 전 한글로 쉽게 설명해주는 강의라 초반 개념잡기에 도움이 된다.

2. 아쉬운 점
- 전체 강의의 2/3 정도는 무료이고, 뒷부분 1/3은 채널에 유료로 가입을 해야 들을 수 있다.
- 2년정도 지난 강의다 보니 실습할 때는 공식 문서를 반드시 참고해야 한다.
```

## 3. 결론

&nbsp;&nbsp;&nbsp;&nbsp;이제 Udemy 강의를 들으며 실습을 통해 시험을 준비할 예정인데, 그 전에 빠르게 기본적인 부분들을 이해하기에 좋은 강으이ㅕㅆ다.
