...
```
Find the files owned by choi, and copy it to /root/found
```

```
# find / -user choi //user choi가 소유자인 파일 모두 검색
# cp /home/choi/kimbab /root/found //kimbab이라는 파일을 찾았다고 가정하고 복사하여 이동
```
