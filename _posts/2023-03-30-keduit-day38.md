...
- Packet 전체 사이즈(Header + Data). 최솟값 20bytes(Data없는 Header)
...
- Packet을 Fragment들로 나눈다. 각각의 Fragment들의 최대 크기는 MUT - IP header size(20-60bytes)
...
![image](https://user-images.githubusercontent.com/124491456/228713242-05c31c8d-eebd-4cfd-a182-619fa1b475db.png)   
(TCP Header)
