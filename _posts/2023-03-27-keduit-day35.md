...
- Classless
- Metric으로로 Bandwidth, Delay, Reliability, Load, MTU를 사용. 위 각각의 Metric을 Vector Metric이라고 하며, 상수값 K로 가중치(기본값은 K1=K3=1, K2=K4=K5=0)를 부여하여 Composite Metric(((1*BW)+(0+BW)/(256-Load)+(1*DLY))*256)을 산출한다.
