...
ctrl + shift + p + q //docker에서 빠져나오기
# docker ps // -a 옵션을 통해 종료된 docker도 확인 가능
# docker attach //CONTAINER ID or NAMES
# exit
# docker rm -f //CONTAINER ID or NAMES
# docker images
# docker rmi ubutu:14.04 //REPOSITORY + TAG = ubuntu:14.04
# docker images
...
# ifconfig
//host pc
http://10.10.51.37/ //on web browser
...
//PPA(Personal Package Archive)는 개인 패키지 저장소로써 개발자가 소스코드를 업로드하
면 자동으로 패키지화하여 사용자가 다운로드 받아 설치할 수 있게 해주는 소프트웨어 저장소
이다. PPA를 통해 최신 버전들을 다운로드 할 수 있다.
