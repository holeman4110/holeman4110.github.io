...
&nbsp;&nbsp;&nbsp;&nbsp;두개의 Switch에 2개 이상의 Port를 연결할 경우 STP에 의해 Block Port가 생성되어 모든 Port를 동시에 사용할 수 없다. 이러한 경우 다수의 Link를 하나의 Logical Port로 묶어서 사용 가능한데, 이를 Cisco에서는 Ether Channel이라고 한다. 다른 벤더에서는 Link-Aggregation이라고 표현하기도 한다.   
...
<img alt="ex" src="https://user-images.githubusercontent.com/124491456/223950770-a67a7e98-2b59-43e4-8ef5-e4aa0aa62acf.png" width=400>   
(GNS는 On Mode만 지원)
